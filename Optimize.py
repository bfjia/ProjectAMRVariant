    ...
    for mapq in range (20):
        ...
        for a in range(10):
            for r in range(0, 500, 2):
                with open (args.temp + str(mapq) + "_DetectedVariants.tsv", 'r') as f:
                ...
                matrix, totalRes, total = GenerateSyntheticData.CheckAccuracy(unfilteredResult, "SyntheticProteinVariants.fasta")
            ...
            for r in range(0, 500, 2):
                ...
                for i in range(len(unfilteredResult)):
                    ...
                    if line[3] == "Resistant Variant":
                        ...
                        line[3] = "False"
                    unfilteredResult[i] = "\t".join(line)
                matrix, totalRes, total = GenerateSyntheticData.CheckAccuracy(unfilteredResult, "SyntheticRRnaVariants.fasta")
                metrics, header = matrix.GetAllMetrics()
                metrics = [str(round(x,4)) for x in metrics]
